...
if (isset($_POST['Borrow'])) {
    ...
    while ($rowCount = mysqli_fetch_array($BookCount)) {
        if ($rowCount['totalNumber'] == 0) {
            ...
            $Borrow = "INSERT INTO borrow (bookId,StudentId) SELECT book.id, student.id FROM book, student WHERE book.id = $id AND student.id = $_SESSION[id]";
        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse">
                <div class="nav navbar-nav navbar-right">
                    <li><a href="books.php?=<?php echo $_SESSION['id']; ?>">Back</a></li>
                </div>
            </div>
        </div>
    </nav>
