                    ...
                    <table width="100%" class="table table-bordered table-bordered table-hover">
                        ...
                        if ($SearchCount >= 1) {
                            while ($SearchRow = mysqli_fetch_array($SearchQuery)) {
                                ...
                                echo "<td class='td1'><a class='btn btn-warning btn-md' data-title='$SearchRow[title]' data-id='$SearchRow[id]' onCLick='confirmBorrow(this);'><i class='fa fa-hand-lizard-o'>Borrow</i></a></td>";
                            }
                        }
                        ?>
                        </tbody>
